...
class SlitMask:
    """
    A slit mask that can be square or circular that will be applied over the
    ...
    kind : str
        Kind of the slit, can be 'square' or 'circle'
    hor : float or int
    ...
    def __init__(self, source_file, kind, hor, ver=None):
        ...
        if kind in ['square', 'circle']:
            ...
            raise RuntimeError("ERROR: please indicate 'square' or 'circle'")
